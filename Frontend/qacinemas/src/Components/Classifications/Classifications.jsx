...
const Classifications = () => {
    return (
        <div className="container">
            ...
            <p align="center"> Classifications can get a little confusing, especially with closely related Classifications.
            ...
            <h2 align="center">U: Universal</h2>
            <p align="center"> U rated films whilst having universal in the name are generally suitable for those aged four and above.
            ...
            film is hopeful and heartwarming throughout.</p>
            <h2 align="center"> PG: Parental Guidance</h2>
            <p align="center"> PG rated films are the next step up, and though according to the BBFC unaccompanied children of any aged
            ...
            a lot more is allowed to be presented as it's older audience can appreciate the depth of the story more.</p>
            <h2 align="center"> 12A/12 Suitable for 12 years and over</h2>
            <p align="center"> 12A/12 is the first actual age based classifcation according to BBFC ratings, there is some confusion surrounding 
            ...
            their own.</p>
            <h2 align="center"> 15 – Suitable only for 15 years and over</h2>
            <p align="center"> 15 is the penulitmate rating the BBFC gives to movies, with no child under the age of 15 being allowed to watch 15 rated films.
            ...
            subplots that include some very bloody violence and underage consumption of drugs (though brief) that edge this film to this rating.</p>
            <h2 align="center"> 18 - Suitable for adults</h2>
            <p align="center"> 18 is the highest level rating the BBFC gives to cinema releases, and unlike the various other BBFC ratings in which details are presented and warning
            ...
            and some gore making it not suitable for children.</p>
        </div>

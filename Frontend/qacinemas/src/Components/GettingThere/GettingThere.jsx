...
const GettingThere = () => {
    return (
        <div align="justify" className="container">
            <h1 align="center" className="text-white">Cinema Details</h1>
            <br></br>
            <center>
                <img width="600" height="600" src= {cinema4}/>
            </center>
            <br></br>
            <br></br>
            <h4 align="center" className="text-white">17-18 Henrietta St</h4>
            <h4 align="center" className="text-white">Covent Garden</h4>
            <h4 align="center" className="text-white">London</h4>
            <br></br>
            <hr></hr>
